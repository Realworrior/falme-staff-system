    ...
    >
      <NavLink to="/" className="hidden md:flex flex-col items-center justify-center mb-12 relative group no-underline">
         <div className="w-12 h-12 group-hover:scale-110 group-hover:rotate-3 transition-all duration-500 overflow-hidden">
           <img src="/favicon.svg" alt="Falme" className="w-12 h-12 object-contain animate-logo-pulse" />
         </div>
                ...
                <div className={cn(
                  ...
                  {item.isNew && (
                    <motion.div 
                      ...
                      className="absolute -top-0.5 -right-0.5 w-2 h-2 bg-accent rounded-full border border-[#0a0a0f] z-10" 
                    />
                  )}
                </div>
                <span className={cn(
