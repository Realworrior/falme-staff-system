async function testLogin() {
  const API_URL = 'https://kgpcruwlejoougjbeouw.supabase.co/functions/v1/make-server-07e1ed14/make-server-07e1ed14';
  ...
  console.log('Testing login via Edge Function...');
