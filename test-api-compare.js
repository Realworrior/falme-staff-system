async function testLogin() {
  ...
  const urls = [
    'https://kgpcruwlejoougjbeouw.supabase.co/functions/v1/make-server-07e1ed14/login',
    'https://kgpcruwlejoougjbeouw.supabase.co/functions/v1/make-server-07e1ed14/make-server-07e1ed14/login'
  ];
